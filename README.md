...
- **新增 inject_ai_spirit_walker.py**：灵魂行者每 0.5s（SalvoTick）自动施法
  - 阶段1 驱散：检测我方单位诅咒(Bcur)/减速(Bslo) buff，英雄优先，释放 Dispel Magic 到目标位置
  - 阶段2 灵魂链：检测我方单位无灵魂链(Bslf) buff，英雄优先，释放 Spirit Link
...
| 阶段 | 检测条件 | 目标选择 | 施法 |
|------|---------|---------|------|
| 1 驱散 | 我方单位有诅咒(`Bcur`)或减速(`Bslo`) | 英雄优先 | Dispel Magic -> 目标位置 |
| 2 灵魂链 | 我方单位无灵魂链(`Bslf`) buff | 英雄优先 | Spirit Link -> 目标单位 |
